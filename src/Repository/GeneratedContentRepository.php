 ...
 */
#[AsRepository(entityClass: GeneratedContent::class)]
class GeneratedContentRepository extends ServiceEntityRepository
{
    ...
    public function findNeedManualAudit(): array
    {
        ...
        return $this->createQueryBuilder('g')
            ...
            ->setParameter('riskLevel', RiskLevel::MEDIUM_RISK->value)
    ...
    public function findByMachineAuditResult(RiskLevel $riskLevel): array
    {
        ...
        return $this->createQueryBuilder('g')
            ->andWhere('g.machineAuditResult = :riskLevel')
            ->setParameter('riskLevel', $riskLevel->value)
     ...
     * 统计各风险等级内容数量
     *
     * @return array<string, mixed> 返回统计结果
     */
     ...
     * 保存实体
     */
    public function save(GeneratedContent $entity, bool $flush = true): void
    {
     ...
     * 删除实体
     */
    public function remove(GeneratedContent $entity, bool $flush = true): void
    {
